...
from data_loaders.data_augmentation import *
# sys.path.insert(0,'../data_preprocess/')
from data_preprocess.acdc_data_preparation import extract_roi_stddev
rng = np.random.RandomState(40)


class CheckIfResizeRequired:
    pass
            ...
            for phase in range(n_phase):
                ...
                if seg_files_path_list or enable_IPG:
                    ...
                    if roi_center:
                        ...
                        rect = matplotlib.patches.Rectangle((roi_center[1]-64, roi_center[0]-64), 128,128,linewidth=1,edgecolor='b',facecolor='none')
